...
.font105[.line-space1-5[
Para utilizar **geom_bar** primero definiremos que variable categórica queremos gráficar, la cual ubicaremos en el eje "y" o en el eje "x". Al igual que en la gráfica anterior utilizaremos la variable categórica `ase_cat`
]]
...
.font105[.line-space1-5[
Luego de definir la variable categórica `ase_cat` que se va a gráficar se debe definir la geométria a utilizar, que este caso será **geom_bar**
]]
...
.font105[.line-space1-5[
Después de tener el gráfico, podemos definir el color de los bordes de la barra y su relleno. Para ello utilizaremos `colour` y `fill`
...
.font105[.line-space1-5[
A continuación le agregamos un tema, el cual le da un formato al fondo de la gráfica. 
...
.font105[.line-space1-5[
Al terminar el gráfico se pueden colocar titulos subtitulos y nombres para cada eje.
...
.font105[.line-space1-5[
En este caso colorearemos el gráfico según la variable **sexo**
]]
.pull-left[
```{r, eval = FALSE}
data %>% 
